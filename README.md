...
```
createuser hs-editorialcms --password hs-editorialcms --superuser
createdb hs-editorialcms
createdb hs-editorialcms_test
```
...
```
stack test --flag hs-editorialcms:library-only --flag hs-editorialcms:dev
```
